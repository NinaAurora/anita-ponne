...
import paintingsOne from "../public/paintings1.jpeg";
import paintingsTwo from "../public/paintings2.jpeg";
import illustration from "../public/illustrations.jpeg";
      ...
      <div className="grid lg:grid-cols-2 md:gap-12">
        ...
        <div className="px-8 md:pr-16 pt-16">
          ...
          <p className="py-4">
            ...
            without sitting on cold floor, and touch water with paw then recoil
            in horror. Curl into a furry donut stretch i cry and cry and cry
            unless you pet me, and then maybe i cry just for fun. Groom yourself
            4 hours - checked, have your beauty sleep 18 hours - checked, be
            fabulous for the rest of the day - checked swat turds around the
            house man running from cops stops to pet cats, goes to jail slap
            kitten brother with paw so annoy owner until he gives you food say
            meow repeatedly until belly rubs, feels good. Sit in a box for
            hours. Milk the cow scratch at door to be let outside, get let out
            then scratch at door immmediately after to be let back in for
            hiiiiiiiiii feed me now. Sleep on dog bed, force dog to sleep on
            floor thug cat cough. Intently sniff hand car rides are evil yet
            found somthing move i bite it tail. Gnaw the corn cob sniff sniff.
            Mesmerizing birds cat mojo . Try to hold own back foot to clean it
            but foot reflexively kicks you in face, go into a rage and bite own
            foot, hard this cat happen now, it was too purr-fect!!! so i will
            ruin the couch with my claws yet cough furball eat fish on floor so
            trip owner up in kitchen i want food. Sit in a box for hours furrier
            and even more furrier hairball but stretch. Lick the plastic bag
            stick butt in face. Pee on walls it smells like breakfast eat prawns
          ...
          <p>
            ...
            pariatur vitae, exercitationem nemo, eum quia placeat inventore
            tenetur provident illo veniam nobis, quo sequi omnis beatae ipsam
            eaque porro corporis.
          </p>
        </div>
      </div>
      ...
      <div className="p-8 md:py-32 md:px-16 grid lg:grid-cols-3 md:gap-24">
        ...
        <div className="bg-gray-100 px-4 text-center">
          ...
          <p className="py-4 px-8">
            ...
            recusandae repellat veniam hic dolore. Ex, fugit quisquam! Quasi
            ducimus rerum modi, magnam voluptate odit nam iure, itaque et,
